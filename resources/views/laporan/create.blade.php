...
@section('title_page', 'Laporan - Create')
            ...
            <div class="x_content">           
                ...
                <div class="form-group row ">
                    ...
                    <div class="col-md-3 col-sm-3 ">
                        <div class='input-group date' id='myDatepicker2'>
                            <input id="tanggal_situasi" name="tanggal_situasi" value="{{ old('tanggal_situasi') }}" type='text' class="form-control{{($errors->first('tanggal_situasi') ? " parsley-error" : "")}}" />
                ...
                <div class="form-group row ">
                    ...
                    <div class="col-md-7 col-sm-7 ">
                        ...
                        <textarea id="situasi_umum" name="situasi_umum" class="resizable_textarea form-control{{($errors->first('situasi_umum') ? " parsley-error" : "")}}" placeholder="Situasi Umum">{{old('situasi_umum')}}</textarea>
                ...
                <div class="form-group row ">
                    ...
                    <div class="col-md-7 col-sm-7 ">
                        ...
                        <textarea id="kejahatan_menonjol_desc" name="kejahatan_menonjol_desc" class="resizable_textarea form-control{{($errors->first('kejahatan_menonjol_desc') ? " parsley-error" : "")}}" placeholder="Deskripsikan kejahatan menonjol yang mau dilaporkan" >{{old('kejahatan_menonjol_desc')}}</textarea>
                ...
                <div class="x_content">                   
                    ...
                    <div class="form-group row ">
                        ...
                        <div class="col-md-7 col-sm-7 ">
                            ...
                            <input id="laporan_polisi" name="laporan_polisi" value="{{ old('laporan_polisi') }}"  type="number" placeholder="Jumlah Data" class="form-control{{($errors->first('laporan_polisi') ? " parsley-error" : "")}}">
                    ...
                    <div class="form-group row ">
                        ...
                        <div class="col-md-7 col-sm-7 ">
                            ...
                            <input id="perkara_sidik" name="perkara_sidik" value="{{ old('perkara_sidik') }}"  type="number" placeholder="Jumlah Data" class="form-control{{($errors->first('perkara_sidik') ? " parsley-error" : "")}}">
                    ...
                    <div class="form-group row ">
                        ...
                        <div class="col-md-7 col-sm-7 ">
                            ...
                            <input id="perkara_lidik" name="perkara_lidik" value="{{ old('perkara_lidik') }}"  type="number" placeholder="Jumlah Data" class="form-control{{($errors->first('perkara_lidik') ? " parsley-error" : "")}}">
                    ...
                    <div class="form-group row ">
                        ...
                        <div class="col-md-7 col-sm-7 ">
                            ...
                            <input id="perkara_selra" name="perkara_selra" value="{{ old('perkara_selra') }}"  type="number" placeholder="Jumlah Data" class="form-control{{($errors->first('perkara_selra') ? " parsley-error" : "")}}">
                    ...
                    <div class="form-group row ">
                        ...
                        <div class="col-md-7 col-sm-7 ">
                            ...
                            <input id="perkara_sp3" name="perkara_sp3" value="{{ old('perkara_sp3') }}"  type="number" placeholder="Jumlah Data" class="form-control{{($errors->first('perkara_sp3') ? " parsley-error" : "")}}">
                    ...
                    <div class="form-group row ">
                        ...
                        <div class="col-md-7 col-sm-7 ">
                            ...
                            <input id="perkara_p21" name="perkara_p21" value="{{ old('perkara_p21') }}"  type="number" placeholder="Jumlah Data" class="form-control{{($errors->first('perkara_p21') ? " parsley-error" : "")}}">
                    ...
                    <div class="form-group row ">
                        ...
                        <div class="col-md-7 col-sm-7 ">
                            ...
                            <input id="perkara_henti_lidik" name="perkara_henti_lidik" value="{{ old('perkara_henti_lidik') }}"  type="number" placeholder="Jumlah Data" class="form-control{{($errors->first('perkara_henti_lidik') ? " parsley-error" : "")}}">
                ...
                <div class="x_content">              
                    ...
                    <div class="form-group row ">
                        ...
                        <div class="col-md-7 col-sm-7 ">
                            ...
                            <input id="upp_pemanggilan" name="upp_pemanggilan" value="{{ old('upp_pemanggilan') }}"  type="number" placeholder="Jumlah Data" class="form-control{{($errors->first('upp_pemanggilan') ? " parsley-error" : "")}}">
                    ...
                    <div class="form-group row ">
                        ...
                        <div class="col-md-7 col-sm-7 ">
                            ...
                            <input id="upp_penangkapan" name="upp_penangkapan" value="{{ old('upp_penangkapan') }}"  type="number" placeholder="Jumlah Data" class="form-control{{($errors->first('upp_penangkapan') ? " parsley-error" : "")}}">
                    ...
                    <div class="form-group row ">
                        ...
                        <div class="col-md-7 col-sm-7 ">
                            ...
                            <input id="upp_penahanan" name="upp_penahanan" value="{{ old('upp_penahanan') }}"  type="number" placeholder="Jumlah Data" class="form-control{{($errors->first('upp_penahanan') ? " parsley-error" : "")}}">
                    ...
                    <div class="form-group row ">
                        ...
                        <div class="col-md-7 col-sm-7 ">
                            ...
                            <input id="upp_penggeledahan" name="upp_penggeledahan" value="{{ old('upp_penggeledahan') }}"  type="number" placeholder="Jumlah Data" class="form-control{{($errors->first('upp_penggeledahan') ? " parsley-error" : "")}}">
                    ...
                    <div class="form-group row ">
                        ...
                        <div class="col-md-7 col-sm-7 ">
                            ...
                            <input id="upp_penyitaan" name="upp_penyitaan" value="{{ old('upp_penyitaan') }}"  type="number" placeholder="Jumlah Data" class="form-control{{($errors->first('upp_penyitaan') ? " parsley-error" : "")}}">
                    ...
                    <div class="form-group row ">
                        ...
                        <div class="col-md-7 col-sm-7 ">
                            ...
                            <input id="jlh_tahanan" name="jlh_tahanan" value="{{ old('jlh_tahanan') }}"  type="number" placeholder="Jumlah Data" class="form-control{{($errors->first('jlh_tahanan') ? " parsley-error" : "")}}">
